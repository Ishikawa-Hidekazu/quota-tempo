...
public struct CodexRateLimitAdapter: Sendable {
  ...
  static let protocolRequest = Data(
    """
    {"method":"initialize","id":1,"params":{"clientInfo":{"name":"quota_tempo","title":"QuotaTempo","version":"0.1.2"},"capabilities":{"optOutNotificationMethods":["account/rateLimits/updated"]}}}
    {"method":"initialized"}
